...
export function AnimatedAIChat({ onSendMessage, isProcessing = false, processingMessage }: AnimatedAIChatProps) {
    ...
    const commandSuggestions: CommandSuggestion[] = [
        { 
            ...
            label: "Swap", 
            description: "Swap fiat to crypto", 
            prefix: "/swap" 
        },
        { 
        ...
        { 
            ...
            label: "Rails", 
            description: "View supported payment rails", 
            prefix: "/rails" 
        },
        { 
    ...
    return (
        <div className="flex flex-col w-full items-center justify-center text-white relative overflow-hidden">
            <div className="w-full max-w-2xl mx-auto relative">
                ...
                >
                    <div className="text-center space-y-3">
                        ...
                        >
                            Try: &quot;swap 100 USD to ETH&quot; or use /commands
                        </motion.p>
                    </div>
            ...
            <AnimatePresence>
                {isProcessing && (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-7 rounded-full bg-emerald-500/20 flex items-center justify-center text-center">
            ...
            {inputFocused && (
                <motion.div 
                    className="fixed w-[50rem] h-[50rem] rounded-full pointer-events-none z-0 opacity-[0.02] bg-gradient-to-r from-emerald-500 via-cyan-500 to-indigo-500 blur-[96px]"
                    animate={{
