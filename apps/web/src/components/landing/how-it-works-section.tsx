        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Swap.</span>
              <span className="block text-white/10">Done.</span>
            </h2>
          </div>
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="flex-1 h-px bg-white/10 overflow-hidden">
                  {activeStep === index && (
                    <div className="h-full bg-emerald-400/50 animate-progress" />
                  )}
                </div>
              </div>
              ...
              <div className={`absolute bottom-0 left-0 right-0 h-1 bg-emerald-400 transition-transform duration-500 origin-left ${
